...
public class CHI4OptionsCase extends AbstractOptionsCase implements OptionsCase {
		
	private IDB myDatabase;
	int factor;
	private List<String> knownSymbols = new ArrayList<String>();
	RiskMessage Rmsg;
	ForecastMessage Fmsg;
	VolUpdate vol;
	...
	public OrderInfo[] placeOrders() {
		...
		for (int i = 0; i < knownSymbols.size(); i++) {
			...
			orders[i] = new OrderInfo(symbol, OrderSide.BUY, 0.00, 0);
		}
		return orders;
	}
